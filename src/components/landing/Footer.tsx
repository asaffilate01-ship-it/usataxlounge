...
const Footer = () => {
  ...
  const socialLinks = [
    {
      icon: Facebook,
      href: "https://www.facebook.com/taxlounge",
      label: "Facebook",
    },
    { icon: Twitter, href: "https://x.com/taxlounge", label: "Twitter" },
    {
      icon: Youtube,
      href: "https://www.youtube.com/@taxlounge",
      label: "YouTube",
    },
    {
      icon: () => (
      ...
      href: "https://www.tiktok.com/@taxlounge",
      label: "TikTok",
    },
  ];
        ...
        <div className="border-t border-border py-4">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-xs text-muted-foreground">
              © {new Date().getFullYear()} TaxCenda. All rights reserved.
